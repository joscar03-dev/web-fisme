<div class="bg-gradient-to-b from-gray-100 to-white">
    ...
    <section class="py-16 px-4 mx-auto max-w-screen-xl overflow-hidden">
                ...
                <div class="overflow-hidden bg-[#133E6B] rounded-lg p-4 shadow-lg">
                    <div class="relative h-20" x-data="carousel()">
                        ...
                        <div class="absolute inset-0 transition-all duration-500 ease-in-out"
                            x-show="activeIndex === 1" x-transition:enter="transition ease-out duration-300"
                            x-transition:enter-start="opacity-0 transform translate-y-full"
                            x-transition:enter-end="opacity-100 transform translate-y-0"
                            x-transition:leave="transition ease-in duration-300"
                            x-transition:leave-start="opacity-100 transform translate-y-0"
        ...
        @if ($evento->tematicas->isNotEmpty())
            <div class="mt-16" x-data="topicsAnimation()" x-ref="topicsContainer">
                <h2 class="text-3xl font-bold text-[#1d4570] mb-8 text-center">Temas Destacados</h2>
                <div class="flex justify-center">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        @foreach ($evento->tematicas as $tematica)
                            <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-500"
                                :class="{
                                    'translate-y-0 opacity-100': topicsInView,
                                ...
                                <div class="p-4 self-auto">
                                    <h2 class="text-lg font-semibold text-[#1d4570] mb-2 text-center">
                                        {{ $tematica->nombre }}
                                    </h2>
                                </div>
                            </div>
        ...
        <section class="bg-gray-100 py-16" id="registro">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    @if ($evento->partners_description)
                        <p class="max-w-2xl mx-auto text-gray-500">
                            {{ $evento->partners_description }}
                        </p>
                    @endif
                </div>
                <div class="flex justify-center">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-4xl">
                        @foreach ($evento->partners as $partner)
                            <div
                                class="bg-white p-6 rounded-lg shadow-lg transform hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out flex items-center justify-center h-32">
                                <img src="{{ asset('storage/' . $partner->img) }}" alt="{{ $partner->nombre }}"
                        ...
                        <div
                            ...
                            @foreach ($precio->beneficios as $beneficio)
                                <p class="flex items-center text-gray-600 mb-2">
                                    ...
                                    </span>{{ $beneficio->nombre }}
                                </p>
                            @endforeach
                            <a href="{{ route('event.registration', ['slug' => $evento->slug, 'tipo_asistente' => $precio->tipo_asistente]) }}"
                ...
                <div class="p-4 overflow-y-auto max-h-[70vh]">
                    <ol class="relative border-l border-blue-500 space-y-8 ml-3">
                        <li class="mb-10 ml-6">
                            ...
                            <h3 class="mb-2 text-lg font-semibold text-gray-900 text-left">Realizar el depósito</h3>
                        ...
                        <li class="mb-10 ml-6">
                            ...
                            <h3 class="mb-2 text-lg font-semibold text-gray-900 text-left">Ingresar a la página del
                                evento</h3>
                            <p class="text-base text-gray-700 text-justify">
                        ...
                        <li class="mb-10 ml-6">
                            ...
                            <h3 class="mb-2 text-lg font-semibold text-gray-900 text-left">Registrar tus datos</h3>
                            <p class="text-base text-gray-700 text-justify">
                        ...
                        <li class="ml-6">
                            ...
                            <h3 class="mb-2 text-lg font-semibold text-gray-900 text-left">Cargar el comprobante de
                                pago</h3>
                            <p class="text-base text-gray-700 text-justify">
                                En la sección de carga de imagen, sube una foto clara del comprobante de depósito.
                            </p>
                            <img src="/images/vaucher.png?height=150&width=300" alt="Imagen de carga de comprobante"
                                class="mt-3 rounded-lg shadow-md">
                        </li>
                    </ol>
                </div>
    ...
    @if ($evento->patrocinadores->isNotEmpty())
        <section class="bg-gray-100 py-16">
            <div class="container mx-auto px-4">
                ...
                <div class="flex flex-wrap justify-center gap-8">
                    @foreach ($evento->patrocinadores as $patrocinador)
                        <div
                            ...
                            <img src="{{ asset('storage/' . $patrocinador->imagen) }}"
                                alt="{{ $patrocinador->nombre }}" class="w-full h-full object-contain">
                        </div>
                    @endforeach
                </div>
            </div>
