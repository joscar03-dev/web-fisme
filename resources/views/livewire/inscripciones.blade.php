    ...
    <div class="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            <div class="max-w-md mx-auto">
                <div>
                    <h1 class="text-2xl font-semibold text-[#133E6B]">Registro para el Evento</h1>
                </div>
                <div class="divide-y divide-gray-200">
                    <form wire:submit.prevent="register" class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                        ...
                        <div class="relative">
                            <select wire:model="evento_id" id="evento_id" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-[#133E6B]">
                                <option value="">Selecciona un evento</option>
                                @foreach($eventos as $evento)
                                    <option value="{{ $evento->id }}">{{ $evento->nombre_evento }}</option>
                                @endforeach
                            </select>
                            <label for="evento_id" class="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-[#133E6B] peer-focus:text-sm">Evento</label>
                        ...
                        <div class="relative">
                            <div x-data="{ isUploading: false, progress: 0 }" 
                                ...
                                <label for="img_boucher" class="flex flex-col items-center px-4 py-6 bg-white text-[#133E6B] rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-[#133E6B] hover:text-white">
                                    ...
                                    <span class="mt-2 text-base leading-normal">Cargar Boucher</span>
