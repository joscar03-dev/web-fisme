    ...
    <div class="bg-white rounded-lg shadow-xl overflow-hidden w-full max-w-md">
        <div class="p-8">
            ...
            <form wire:submit.prevent="register" class="space-y-4">
                <div>
                    <label for="evento_id" class="block text-sm font-medium text-gray-700">Eventos</label>
                ...
                <div>
                    <label for="institucion_procedencia" class="block text-sm font-medium text-gray-700">Institución de
                        Procedencia</label>
                    <input wire:model="institucion_procedencia" id="institucion_procedencia" type="text"
                        class="mt-1 focus:ring-[#001f54] focus:border-[#001f54] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                        placeholder="Ingrese su institución de procedencia">
                ...
                <div>
                    <label for="tipo_asistente" class="block text-sm font-medium text-gray-700">Tipo de
                        Asistente</label>
                    <select wire:model="tipo_asistente" id="tipo_asistente"
                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-[#001f54] focus:border-[#001f54] sm:text-sm rounded-md">
                        <option value="">Selecciona tipo de asistente</option>
                        <option value="ESTUDIANTE FISME">ESTUDIANTE FISME S/. 50</option>
                        <option value="DOCENTE FISME">DOCENTE FISME S/. 60</option>
                        <option value="EGRESADO FISME">EGRESADO FISME S/. 60</option>
                        <option value="DOCENTE UNTRM">DOCENTE UNTRM S/. 70</option>
                        <option value="PÚBLICO GENERAL - ESTUDIANTE">PÚBLICO GENERAL - ESTUDIANTE S/. 85</option>
                        <option value="PÚBLICO GENERAL - PROFESIONAL">PÚBLICO GENERAL - PROFESIONAL S/. 100</option>
                    </select>
                    @error('tipo_asistente')
                        <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                    @enderror
                </div>
                <div>
                ...
                <div>
                    <label for="entidad_financiera" class="block text-sm font-medium text-gray-700">Entidad
                        Financiera</label>
                    <input wire:model="entidad_financiera" id="entidad_financiera" type="text"
                        class="mt-1 focus:ring-[#001f54] focus:border-[#001f54] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
