        ...
        <div class="p-8">
            ...
            <form wire:submit.prevent="register" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6"> <!-- Cambiado a una columna -->
                    ...
                    <div>
                        <label for="institucion_procedencia" class="block text-sm font-medium text-gray-700">Institución de Procedencia</label>
                    ...
                    <div>
                        <label for="tipo_asistente" class="block text-sm font-medium text-gray-700">Tipo de Asistente</label>
                        <select wire:model="tipo_asistente" id="tipo_asistente"
                            class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-[#001f54] focus:border-[#001f54] sm:text-sm rounded-md">
                            <option value="">Selecciona tipo de asistente</option>
                            <option value="ESTUDIANTE FISME">ESTUDIANTE FISME</option>
                            <option value="DOCENTE FISME">DOCENTE FISME</option>
                            <option value="EGRESADO FISME">EGRESADO FISME</option>
                            <option value="DOCENTE UNTRM">DOCENTE UNTRM</option>
                            <option value="PÚBLICO GENERAL - ESTUDIANTE">PÚBLICO GENERAL - ESTUDIANTE</option>
                            <option value="PÚBLICO GENERAL - PROFESIONAL">PÚBLICO GENERAL - PROFESIONAL</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" id="precio" wire:model="precio" readonly
                            class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-[#001f54] focus:border-[#001f54] sm:text-sm rounded-md">
                    </div>                    
                    <div>
                    ...
                    <div>
                        <label for="tipo" class="block text-sm font-medium text-gray-700">Tipo de Venta</label>
