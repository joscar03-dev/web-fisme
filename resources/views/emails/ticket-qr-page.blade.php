    ...
    <div class="bg-[#133E6B] p-1 rounded-lg shadow-2xl">
        <div class="bg-white p-6 rounded-lg relative overflow-hidden">
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-gray-700 mt-2"><span class="font-bold text-[#133E6B]">18-20 Nov</span> | <span
                        class="font-bold text-[#133E6B]">9:00am - 06:00pm</span></p>
            ...
            <div class="flex flex-col justify-center items-center mb-6 bg-gray-50 p-4 rounded-lg shadow-inner">
                <h3 class="text-lg font-semibold text-[#133E6B] mb-2">Información del Asistente</h3>
                <p class="text-gray-700"><strong>Nombre:</strong> {{ $registro->nombres }}
                    {{ $registro->apellidos }}</p>
                <p class="text-gray-700"><strong>Documento:</strong> {{ $registro->numero_documento }}</p>
                <p class="text-gray-700"><strong>Asistente:</strong> {{ $registro->tipo_asistente }}</p>
                <p class="text-gray-700"><strong>Email:</strong> {{ $registro->email }}</p>
            </div>

            <!-- Mensaje de advertencia -->
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600 italic">Este ticket es personal e intransferible. Presente el código QR
                    al ingresar al evento.</p>
            </div>

            <!-- Botones de acción -->
            <div class="mt-6 flex justify-center space-x-4">
                <button
                    class="bg-[#133E6B] text-white px-6 py-2 rounded-full hover:bg-opacity-90 transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#133E6B] focus:ring-opacity-50"
